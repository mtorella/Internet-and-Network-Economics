...
def build_year(year: int) -> list[dict]:
    ...
    for _, p in panel.iterrows():
        ...
        rows.append({
            ...
            "betweenness": _f(p.get("betweenness")),
            "betweenness_norm": _f(p.get("betweenness_norm")),
            "in_strength": _f(p.get("in_strength")),
            "in_strength_norm": _f(p.get("in_strength_norm")),
            "out_strength": _f(p.get("out_strength")),
            "out_strength_norm": _f(p.get("out_strength_norm")),
